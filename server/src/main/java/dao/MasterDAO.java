...
public class MasterDAO {
    ...
    /**
     * Initializes a new connection to the family map database when creating a MasterDAO object.
     */
    public MasterDAO(){ //when preparing to do DAO operations, create a connection that they can all use
        try{
