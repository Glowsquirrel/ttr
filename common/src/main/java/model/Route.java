...
public class Route {
    ...
    public static Map<Integer, Route> createRouteMap() {
        ...
        routeMap.put(44, new Route(DULUTH, WINNIPEG, 5, BLACK, -1));
        routeMap.put(45, new Route(EL_PASO, HOUSTON, 3, GREEN, -1));
        routeMap.put(46, new Route(EL_PASO, LOS_ANGELES, 6, BLACK, -1));
        routeMap.put(47, new Route(EL_PASO, OKLAHOMA_CITY, 6, YELLOW, -1));
        routeMap.put(48, new Route(EL_PASO, PHOENIX, 3, WILD, -1));
        routeMap.put(49, new Route(EL_PASO, SANTA_FE, 6, GREEN, -1));
        ...
        routeMap.put(57, new Route(KANSAS_CITY, OMAHA, 2, WILD, 58));
        routeMap.put(58, new Route(KANSAS_CITY, OMAHA, 2, WILD, 57));
        ...
        routeMap.put(84, new Route(PITTSBURGH, ST_LOUIS, 4, YELLOW, -1));
